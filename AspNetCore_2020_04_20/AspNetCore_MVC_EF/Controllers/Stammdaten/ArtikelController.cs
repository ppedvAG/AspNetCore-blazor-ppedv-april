...
namespace AspNetCore_MVC_EF.Controllers.Stammdaten
{
    public class ArtikelController : Controller
    {
        private readonly BlogDbContext _context;

        public ArtikelController(BlogDbContext context)
        {
            _context = context;
        }


        [Route("AlterController")]
        [Route("AlterController/Index")]
        public async Task<IActionResult> Index()
        {
            return View(await _context.Blog.ToListAsync());
        }

        // GET: AlterController/Details/1

        [Route("AlterController/Details/{id:int}")]
